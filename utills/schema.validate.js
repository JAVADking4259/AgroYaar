...
const addingProduct = yup.object().shape({
    ...
    plantingDate: yup.date().required('please enter a Valid date').min(new Date(1402, 0, 1), 'Date must be later than January 1, 2000'),
    harvestDate: yup.date().required('please enter a Valid date').min(new Date(1402, 0, 1), 'Date must be later than January 1, 2000'),
